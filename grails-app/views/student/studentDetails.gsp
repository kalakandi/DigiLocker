                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-1">
                                <div class="form-group label-floating">
                                    ...
                                    <span class="form-control" disabled> Kumar </span>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group label-floating">
                                    <label class="form-control-label">Last Name </label>
                                    <span class="form-control" disabled> Shivay </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-1">
                                <div class="form-group label-floating">
                                    ...
                                    <span class="form-control" disabled> 1603010143 </span>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group label-floating">
                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-1">
                                <div class="form-group label-floating">
                                    ...
                                    <span class="form-control" disabled> studentmail@gmail.com </span>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group label-floating">
                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-1">
                                <div class="form-group label-floating">
                                    ...
                                    <span class="form-control" disabled> Male </span>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group label-floating">
                                    <label class="form-control-label">Date Of Birth </label>
                                    <span class="form-control" disabled> 01/07/1997 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-1">
                                <div class="form-group label-floating">
                                    ...
                                    <span class="form-control" disabled><span class="prepend">Mr. </span>Om Prakash Yadav  </span>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group label-floating">
                                    <label class="form-control-label"> Mother's Name </label>
                                    <span class="form-control" disabled><span class="prepend">Mrs. </span>Poonam Yadav </span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
