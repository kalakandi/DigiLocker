                                ...
                                <div class="row">
                                    <div class="col-sm-5 offset-sm-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="firstName" type="text" class="form-control" value="Kumar"disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group label-floating">
                                            <label class="form-control-label">Last Name </label>
                                            <input name="lastName" type="text" class="form-control" value="Shivay"  disabled="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-5 offset-sm-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="studentEmail" type="email" class="form-control" value="abc@gmail.com" disabled/>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group label-floating">
                                            <label class="form-control-label">Contact Number </label>
                                            <input name="studentContact" type="text" class="form-control" value="1234567890" disabled/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 offset-sm-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="dateOfBirth" class="form-control" value="01/01/1998" id="dateOfBirth" disabled="true"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-group label-floating" >
                            ...
                            <div class="tab-pane" id="academics">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-sm-1">
                                        ...
                                        <input type="file" id="xMarksheet" name="xMarksheet" accept="image/jpeg"/>
                                    </div>
                                    <div class="col-sm-5 offset-sm-1">
                                        <div class="form-group label-floating">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 offset-sm-1">
                                        ...
                                        <input type="file" id="xiiMarksheet" name="xiiMarksheet" accept="image/jpeg"/>
                            ...
                            <div class="tab-pane" id="other">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 offset-sm-1">
                                        ...
                                        <input type="file" id="diplomaMarksheet" name="diplomaMarksheet" accept="image/jpeg"/>
